...
case "${component}" in
    "hab")
        ...
        echo "<br>* hab-version-${pkg_target:?} ${pkg_ident}" | buildkite-agent annotate --append --context "debug-log"
        ;;
    "studio")
        ...
        echo "<br>* studio-version-${pkg_target:?} ${pkg_ident}" | buildkite-agent annotate --append --context "debug-log"
        ;;
    *)
        ;;
esac
